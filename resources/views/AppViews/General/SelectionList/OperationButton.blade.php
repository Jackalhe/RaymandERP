    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="form-group">
                ...
                {{--<button type="button" class="btn btn-success btn-min-width mr-1 mb-1" onclick="location.href='{{isset($route_title) ? route("$route_title.destroyall") : ''}}'">@lang('messages.New')</button>--}}

                {!! Form::open(['method' => 'POST','route' => ["$route_title.destroyall",'IsDelete'=>true],'style'=>'display:inline','IsDelete1'=>true]) !!}
